...
export default function MainView() {
  return (
    <section className='relative w-full'>
      ...
      <p className='absolute font-tangerine font-thin text-9xl text-almostBlack top-28 left-1/2 -translate-x-1/2'>CV</p>
      <h1 className='text-6xl text-lightBrown font-cormorant font-light text-center' >CAROLINA & VICTOR</h1>
      ...
      <div className='w-full flex flex-col items-center'>
        ...
        <p className='text-2xl text-almostBlack/80 font-cormorant font-light text-center uppercase'>Jul. <span className='font-koh'>25</span></p>
