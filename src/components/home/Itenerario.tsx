  ...
  return (
    <div className='w-full flex flex-col items-center mt-20'>
        ...
        <div className='relative w-full flex'>
          <div className='absolute w-10/12 h-1 bg-lightBrown rounded-full top-[150px] left-20' />
          <div className='absolute w-6 h-6 bg-lightBrown rounded-full top-[140px] left-[60px]' />
          <div className='absolute w-6 h-6 bg-lightBrown rounded-full top-[140px] left-[205px]' />
          <div className='absolute w-6 h-6 bg-lightBrown rounded-full top-[140px] right-[205px]' />
          <div className='absolute w-6 h-6 bg-lightBrown rounded-full top-[140px] right-[60px]' />
          <div className='w-1/4 flex flex-col space-y-12'>
            ...
            <div className='w-full flex flex-col items-center'>
              <Image src={arrivar} alt='rama' width={40} height={40} />
          ...
          <div className='w-1/4 flex flex-col space-y-12'>
            <div className='w-full h-32 flex flex-col items-center justify-end'>
              <Image src={llegadanovios} alt='rama' width={40} height={40} />
        ...
        <div className='relative w-full flex'>
          ...
          <div className='w-1/4 flex flex-col space-y-12'>
            ...
            <div className='w-full flex flex-col items-center'>
              <Image src={entradanovios} alt='rama' width={40} height={40} />
